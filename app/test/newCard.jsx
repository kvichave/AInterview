  ...
  return (
    <div>
      <BackgroundGradient
        ...
        className="rounded-[22px] w-96  max-w-sm p-4 sm:p-10 bg-white dark:bg-zinc-900"
      >
        <Image
          src={
            imageLink
        ...
        {isSpeaking ? (
          <button className="rounded-full pl-4 pr-1 py-1 text-white flex items-center space-x-1 bg-green-500 mt-4 text-xs font-bold dark:bg-zinc-800">
            <span>SPEAKING </span>
